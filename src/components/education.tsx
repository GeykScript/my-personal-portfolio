    ...
    return (
         <div className="border border-gray-200 rounded-lg flex flex-col p-4 shadow-sm ">
            ...
            <div className="mt-2 p-2 border-t-2 border-gray-100">
                <h2 className="font-bold text-gray-800 mt-1">Bachelor of Science in Information Technology</h2>
                ...
                <p className="text-sm text-gray-400 flex items-center gap-1"><span className="material-icons scale-70 text-gray-500">calendar_month</span>
